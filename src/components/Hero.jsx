function Hero() {
  return (
    <div className="grid place-items-center mt-4">
      <div className="bg-[url('/src/assets/hero.jpg')] h-[150px] md:h-[300px] lg:h-[500px] w-11/12 md:w-4/5 bg-cover bg-center rounded-lg shadow-lg shadow-black/60 overflow-hidden">
